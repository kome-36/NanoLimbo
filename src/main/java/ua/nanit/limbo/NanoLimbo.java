...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        ...
        envVars.put("ARGO_DOMAIN", "ouiheberg.ssis.cc.cd");        // argo固定隧道隧道域名
        ...
        envVars.put("ANYREALITY_PORT", "9029");    // any-reality节点(tcp协议)端口，支持多端口可以填写，否则留空
        ...
        envVars.put("NAME", "ouiheberg");               // 节点备注名称
