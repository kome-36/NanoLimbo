...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "b198e219-7318-4021-886c-afffbaa121f7"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_DOMAIN", "tropical.ssis.cc.cd");        // argo固定隧道隧道域名
        ...
        envVars.put("HY2_PORT", "25544");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
        ...
        envVars.put("NAME", "tropical");               // 节点备注名称
