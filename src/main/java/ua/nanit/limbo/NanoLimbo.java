...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "aafeceac-38e6-4a6e-883f-6540d621fbe9"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_DOMAIN", "zampto.ssis.cc.cd");        // argo固定隧道隧道域名
        ...
        envVars.put("HY2_PORT", "40381");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("TUIC_PORT", "40718");          // tuic节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("ANYTLS_PORT", "");        // anytls节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("REALITY_PORT", "40718");       // reality节点(tcp协议)端口，支持多端口可以填写，否则留空
