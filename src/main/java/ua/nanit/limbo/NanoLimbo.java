...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        ...
        envVars.put("ARGO_DOMAIN", "minestrator.ssis.cc.cd");        // argo固定隧道隧道域名
        ...
        envVars.put("HY2_PORT", "22417");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
        ...
        envVars.put("NAME", "minestrator");               // 节点备注名称
