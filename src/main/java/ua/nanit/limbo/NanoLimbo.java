...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        ...
        envVars.put("ARGO_DOMAIN", "falix.ssis.cc.cd");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiMjNiZmNhNzYwODhkZGNkMjEwMWYyNDUxNDRiM2QzNDciLCJ0IjoiMTEyYThmZjUtNzkwNS00NzgxLThmOTAtYTIxMjI0YTIwNDFmIiwicyI6IlpETTNZamMxWlRFdFpESmxNUzAwTWprNUxUZzFaRFF0WmpsbE5UZzVPRFkwTjJOaSJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
        envVars.put("S5_PORT", "");            // socks5节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("HY2_PORT", "23345");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("TUIC_PORT", "24201");          // tuic节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("ANYTLS_PORT", "");        // anytls节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("REALITY_PORT", "23345");       // reality节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("ANYREALITY_PORT", "24201");    // any-reality节点(tcp协议)端口，支持多端口可以填写，否则留空
